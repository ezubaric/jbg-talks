...
\column{.5\linewidth}
  ...
  \column{.5\linewidth}
  \begin{itemize}
    \item We have a set of actions (answer / translate)
    \item In a changing environment (state)
    \item With a well defined reward
      \pause
...
\frame{
	...
	\frametitle{Thanks}
        ...
        \begin{block}{Collaborators}
          ...
          (Princeton), Philip Resnik (UMD), Christiane Fellbaum
          (Princeton), NAQT
        \end{block}
