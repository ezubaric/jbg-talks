...
\begin{frame}{Exhibition Schedule (Approximate)}
  ...
  \begin{itemize}
     \item[11:00] Brief Intro, Let People Leave, Setup
     \item[11:10] Presentation
     \item[11:20] Faculty vs. Computer
     \item[11:35] MAQT vs. Computer
     \item[11:50] Questions
     \item[12:00] Free for all!
  \end{itemize}

  Find out more at {\bf qanta.org}.  Looking for sponsors for
  human-computer question answering competitions at high school /
  college level.
