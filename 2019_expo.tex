...
\begin{frame}{Exhibition Schedule (Approximate)}
  ...
  \begin{itemize}
     \item[11:00] Heads Up, Let People Leave, Setup
     \item[11:10] Presentation
     \item[11:20] Faculty vs. Computer
     \item[11:35] MAQT vs. Computer
     \item[11:50] Questions
     \item[12:00] Free for All: Take on the System!
  \end{itemize}
...
\fsi{general_figures/blackbox}{What's Left?}
...
\begin{frame}{Can we improve QA systems and keep the fun going?}
