...
\begin{columns}
  \column{.5\linewidth}
\begin{center}
\includegraphics[width=0.75\linewidth]{topic_models/tobacco_litigation} \\
\includegraphics[width=0.75\linewidth]{topic_models/nih_topics} \\
\includegraphics[width=0.65\linewidth]{topic_models/sentiment}
\end{center}
...
\begin{block}{Online Adaptor Grammars with Hybrid Inference}
...
\begin{frame}{PCFGs}
         ...
         \only<1>{\gfxag{pcfg_00}{.7}}
         \only<2>{\gfxag{pcfg_01}{.7}}
         \only<3>{\gfxag{pcfg_02}{.7}}
         \only<4>{\gfxag{pcfg_03}{.7}}
         \only<5>{\gfxag{pcfg_04}{.7}}
         \only<6>{\gfxag{pcfg_05}{.7}}
  ...
  \begin{columns}
    ...
    \column{.75\linewidth}
        \begin{block}{Adaptor Grammars}
          \vspace{-.9cm}
         \only<1>{\gfxag{ag_00}{.8}}
         \only<2>{\gfxag{ag_01}{.8}}
         \only<3>{\gfxag{ag_02}{.8}}
         \only<4>{\gfxag{ag_03}{.8}}
         \only<5>{\gfxag{ag_04}{.8}}
         \only<6>{\gfxag{ag_05}{.8}}
         \only<7>{\gfxag{ag_06}{.8}}
         \only<8>{\gfxag{ag_07}{1}}
         \only<9>{\gfxag{ag_08}{1}}
         \only<10>{\gfxag{ag_09}{1}}
         \only<11>{\gfxag{ag_10}{1}}
         \only<12>{\gfxag{ag_11}{1}}
         \only<13>{\gfxag{ag_12}{1}}
                   \vspace{-.9cm}
      \end{block}
      \end{columns}
\end{frame}
