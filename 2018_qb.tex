...
\begin{frame}{Competition}
  ...
  \begin{itemize}
    ...
    \item Actual Match: much different!
  \end{itemize}
  ...
  \begin{itemize}
    ...
    \item Infrastructure for future events / courses
      \begin{itemize}
        ...
        \item \alert<2>{Tell your friends:} Competition (December 15, College Park)
      \end{itemize}
  \end{itemize}
...
\begin{frame}[plain]
        ...
        \begin{center}
          \includegraphics[width=0.4\linewidth]{general_figures/twitter} \\
\huge
http://qanta.org \\
http://boydgraber.org
       \end{center}
