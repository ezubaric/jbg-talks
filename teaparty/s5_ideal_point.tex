...
\frame{
    ...
    \includegraphics[width=.20\textwidth]{teaparty/figures/section_icons_1}
    \includegraphics[width=.20\textwidth]{teaparty/figures/section_icons_2}
    \includegraphics[width=.20\textwidth]{teaparty/figures/section_icons_3}
    \includegraphics[width=.35\textwidth]{teaparty/figures/section_icons_4}
    \begin{block}{}
        \begin{itemize*}
...
\frame{
    ...
    \begin{figure}
      \centering
        \only<1>{\includegraphics[width=.9\textwidth]{teaparty/figures/s5/4_multdim_ip_eqn}}%
        \only<2>{\includegraphics[width=.9\textwidth]{teaparty/figures/s5/5_multdim_ip_eqn_explained}}%
        \only<3->{\includegraphics[width=.9\textwidth]{teaparty/figures/s5/5a_multdim_ip_eqn_highlighted}}%
    \end{figure}
    \vspace{-.3cm}
    \hfill \tiny{\cite{Heckman:NBER96,Jackman:PA01,Clinton:APSR04}}
    \begin{figure}
        \only<1-2>{\includegraphics[width=.8\textwidth]{teaparty/figures/s5/dimensions_0}}%
        \only<3>{\includegraphics[width=.8\textwidth]{teaparty/figures/s5/dimensions_3}}%
        \only<4>{\includegraphics[width=.8\textwidth]{teaparty/figures/s5/dimensions_4}}%
    \end{figure}
}%
...
\frame{
    ...
    \begin{figure}
      \centering
        \only<1>{\includegraphics[width=.9\textwidth]{teaparty/figures/s5/1a_votes_text}}%
        \only<2>{\includegraphics[width=.9\textwidth]{teaparty/figures/s5/6_multdim_ip_text_eqn}}%
        \only<3->{\includegraphics[width=.9\textwidth]{teaparty/figures/s5/7_multdim_ip_text_eqn_explained}}%
    \end{figure}
    \vspace{-.3cm}
    \hfill \tiny{} \cite{Gerrish:NIPS12,Bonica:AJPS13:ideology,Lauderdale:AJPS14,Sim:AAAI15:utility}
    \begin{figure}
        \only<1-3>{\includegraphics[width=.8\textwidth]{teaparty/figures/s5/dimensions_4}}%
        \only<4->{\includegraphics[width=.8\textwidth]{teaparty/figures/s5/dimensions_5}}%
    \end{figure}
}%
...
\frame{
    ...
    \begin{figure}
      ...
      \only<2>{\includegraphics[width=.9\textwidth]{teaparty/figures/s5/output_2}}%
...
\frame{
    ...
    \begin{columns}
      ...
      \vspace{-.5cm}
      \begin{center}
        \includegraphics<1>[width=.85\textwidth]{teaparty/figures/s5/bottom_0}%
        \includegraphics<2-3>[width=.85\textwidth]{teaparty/figures/s5/bottom_1}%
      \end{center}
        \only<4>{
        \vspace{-1cm}
            \begin{block}{}
...
allies}.''
      ...
      \vspace{-.5cm}
      \begin{center}
        \includegraphics<1>[width=.85\textwidth]{teaparty/figures/s5/top_0}%
        \includegraphics<2,4>[width=.85\textwidth]{teaparty/figures/s5/top_1}%
      \end{center}
        \only<3>{
        \vspace{-1cm}
            \begin{block}{}
...
\frame{
    ...
    \begin{figure}
      \centering
        \includegraphics<1>[width=.75\textwidth]{teaparty/figures/s5/multdim_ip_112}%
        \includegraphics<2->[width=\textwidth]{teaparty/figures/s5/mult_ip_top}%
    \end{figure}
    \only<2->{
        \begin{block}{}
