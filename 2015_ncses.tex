...
\only<5>{
\centering
Caveat: dataset with gold labels (Congressional Records)
}
\end{frame}
...
\begin{Itemize}
  \item Curate topics to answer several RFQs
  \item Different set of users rates applicability/quality
  \item Compare to underlying value
\end{Itemize}
