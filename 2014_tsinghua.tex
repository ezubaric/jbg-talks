...
\begin{columns}
  \column{.5\linewidth}
\begin{center}
\includegraphics[width=0.65\linewidth]{topic_models/tobacco_litigation} \\
\includegraphics[width=0.65\linewidth]{topic_models/nih_topics} \\
...
\begin{frame}
  ...
  \begin{columns}
    \column{.2\linewidth}
       \includegraphics[width=.85\linewidth]{cognitive/crowdsourcing_on}
    \column{.6\linewidth}
  ...
  \begin{columns}
    \column{.2\linewidth}
       \includegraphics[width=.85\linewidth]{cognitive/user_on}
    \column{.6\linewidth}
  ...
  \begin{columns}
    \column{.2\linewidth}
       \includegraphics[width=.85\linewidth]{cognitive/algorithms_on}
    \column{.6\linewidth}
...
\begin{center}
\only<1>{\includegraphics[width=.9\linewidth]{reading_tea_leaves/tasks/word1}  }
\only<2>{\includegraphics[width=.9\linewidth]{reading_tea_leaves/tasks/word2}  }
\pause
  \begin{itemize}
...
\begin{frame}{One Solution: Parallelization}
  \begin{center}
    \includegraphics[width=.6\linewidth]{infvoc/parallel} \\
