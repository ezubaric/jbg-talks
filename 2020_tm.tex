...
\input{topic_models/mtanchor/colorize}
...
%\usetheme{Singapore}
% \usecolortheme{umd}
\title{Interactive, Multilingual Topic Models}
...
\frame{
  \begin{center}
    \huge Interactive, Multilingual Topic Models \\
    \vspace{2cm}
    \large Jordan Boyd-Graber, 2020
  \end{center}
}
...
\includegraphics[width=.8\linewidth]{topic_models/mtanchor/michelle}

\column{.5\linewidth}


\begin{block}{Multilingual Anchoring: Interactive Topic Modeling and Alignment Across Languages}
...
\tiny
\bibliography{bib/journal-full,bib/jbg,bib/michelle,bib/vietan}
\end{frame}
