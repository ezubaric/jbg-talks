...
\end{itemize}
  \column{.5\linewidth}
    \gfxq{esp}{.5}
    \cite{ahn-06,bowser-13}
    \gfxq{citizen-science}{.3}
\end{columns}
\end{frame}
...
\begin{frame}{Computers are Good at Memorizing}
  ...
  \begin{center}
  \href{https://www.youtube.com/watch?v=MzM1oNsm8MQ&feature=youtu.be&t=136&autoplay=1;fs=0;autohide=0;}{Poems, TV Shows, Artwork}
  \end{center}
    \gfxq{hsnct_2017}{1.0}
